...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 03 juil. 2019 à 12:00
...
(1, 'tib@tib.fr', '[\"ROLE_SUPER_ADMIN\"]', '$argon2i$v=19$m=1024,t=2,p=2$Uy9vdmZwSE1ONkNBVXlLcQ$OYBgJOGi3UqD7g01SrEpvOIQt3jzP4dZs1QoKsvl89o', '2019-07-01 00:00:00'),
(2, 'jules@jules.fr', '{\"2\": \"ROLE_MODERATEUR\"}', '$argon2i$v=19$m=1024,t=2,p=2$ZnNUbHIuRDZiVkRlbFRlNg$LQBIHGo9rIIwWOgRII3LHhcgnlj2mfL050w5/VoXs3c', '2019-07-01 00:00:00'),
